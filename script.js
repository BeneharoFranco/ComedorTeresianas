function updateSchedule() {
  ...
  const currentMonth = monthes[now.getMonth()];
  const currentDay = days[now.getDay()];
  const currentDate = now.getDate();

  document.getElementById('currentDay').textContent = `Hoy ${currentDate} de ${currentMonth}, ${currentDay} tenemos de menú:`;
    ...
    case 'Marzo':
      switch (currentDate) {
        ...
        case 17: message = 'Crema de verduras de temporada. Estofado de ternera con verduras. Arroz integral. Fruta de temporada.'
          break;
        case 18: message = 'Ensalada de con Croquetas de Menestra Fruta de papas aliñadas melva. pescado caseras. de verduras. temporada.'
          break;
    ...
    case 'Abril':
      switch (currentDate) {
        ...
        case 28: message = 'Crema de verduras de temporada. Estofado de ternera con verduras. Arroz integral. Fruta de temporada.'
          break;
        case 29: message = 'Ensalada de con Croquetas de Menestra Fruta de papas aliñadas melva. pescado caseras. de verduras. temporada.'
          break;
    ...
    case 'Junio':
      switch (currentDate) {
        ...
        case 2: message = 'Crema de verduras de temporada. Estofado de ternera con verduras. Arroz integral. Fruta de temporada.'
          break;
        case 3: message = 'Ensalada de con Croquetas de Menestra Fruta de papas aliñadas melva. pescado caseras. de verduras. temporada.'
          break;
